...
void Tests::test_Kunde() {
  Kunde kunde{"LeBron James", "male", 40, "lebron.james@gmail.com",
              "Los Angeles, USA"};
...
void Tests::test_Haendler() {
  Haendler haendler{"Leonidas Arkona", "male", 28, "leonidas.arkona@esn.com",
                    "Protein 1, 82617, Proteinos"};
...
void Tests::test_Warenkorb() {
  ...
  auto shared_kunde = std::make_shared<Kunde>(
      "LeBron James", "male", 30, "lebron.james@gmail.com", "Los Angeles, USA");
  ...
  assert(std::abs(warenkorb.GetGesamtPreis() -
                  ((1.99f * 3.0f) + (2.52f * 4.49f))) < 0.001f);
...
void Tests::test_Konto() {
  auto shared_kunde =
      std::make_shared<Kunde>("Jonathan Joestar", "male", 35,
                              "jonathan.joestar@yahoo.com", "London, UK");
...
void Tests::test_Kassenzettel() {
  ...
  auto shared_kunde1 = std::make_shared<Kunde>(
      "Kujo Jotaro", "male", 30, "jotaro.kujo@gmail.com", "Tokyo, Japan");
  auto shared_kunde2 =
      std::make_shared<Kunde>("Josuke Higashikata", "male", 16,
                              "josuke.higashikata@yahoo.com", "Morioh, Japan");

  Haendler haendler1{"Jonathan Joestar", "male", 76, "jonathan.joestar@gmx.net",
                     "London, England"};
  Haendler haendler2{"Girono Giovanna", "male", 19, "giorno.giovanna@gmail.com",
                     "Rom, Italien"};

  auto shared_konto1 =
      std::make_shared<Konto>(shared_kunde1, "Bank of America");
  ...
  Kassenzettel kassenzettel1{datum1, shared_kunde1, haendler1, warenkorb1,
                             shared_konto1};
  kassenzettel1.CreateKassenzettel();
  assert(shared_konto1->GetKontostand() ==
         100.0f - warenkorb1.GetGesamtPreis());

  Kassenzettel kassenzettel2{datum2, shared_kunde2, haendler1, warenkorb1,
                             shared_konto2};
...
void Tests::test_Supermarkt() {
  ...
  auto kunde1 = std::make_shared<Kunde>(
      "Kujo Jotaro", "male", 30, "jotaro.kujo@gmail.com", "Tokyo, Japan");
  auto kunde2 =
      std::make_shared<Kunde>("Josuke Higashikata", "male", 16,
                              "josuke.higashikata@yahoo.com", "Morioh, Japan");
  ...
  Haendler haendler1{"Jonathan Joestar", "male", 76, "jonathan.joestar@gmx.net",
                     "London, England"};
  Haendler haendler2{"Giorno Giovanna", "male", 19, "giorno.giovanna@gmail.com",
                     "Rom, Italien"};
  ...
  Kassenzettel kassenzettel1{datum1, kunde1, haendler1, warenkorb1,
                             shared_konto1};
  kassenzettel1.CreateKassenzettel();

  auto shared_konto2 = std::make_shared<Konto>(kunde2, "Deutsche Bank");
  Kassenzettel kassenzettel2{datum2, kunde2, haendler1, warenkorb1,
                             shared_konto2};
  kassenzettel2.CreateKassenzettel();
  ...
  supermarkt1.CreateProduktDatabase();
  assert(supermarkt1.CreateProduktDatabase() ==
         "./data/supermarkt_0/produkte.txt");
  ...
  assert(supermarkt1.CreateHaendlerDatabase() ==
         "./data/supermarkt_0/haendler.txt");
  assert(std::filesystem::exists(supermarkt1.CreateHaendlerDatabase()));

  supermarkt1.CreateWarenkorbDatabase();
  assert(supermarkt1.CreateWarenkorbDatabase() ==
         "./data/supermarkt_0/warenkoerbe.txt");
  ...
  assert(supermarkt2.CreateProduktDatabase() ==
         "./data/supermarkt_1/produkte.txt");
  ...
  assert(supermarkt2.CreateHaendlerDatabase() ==
         "./data/supermarkt_1/haendler.txt");
  assert(std::filesystem::exists(supermarkt2.CreateHaendlerDatabase()));
  supermarkt2.CreateWarenkorbDatabase();
  assert(supermarkt2.CreateWarenkorbDatabase() ==
         "./data/supermarkt_1/warenkoerbe.txt");
...
void Tests::test_ReadData() {
  ...
  std::string verkaeufer_content(
      (std::istreambuf_iterator<char>(verkaeufer_file)),
      std::istreambuf_iterator<char>());
  ...
  std::string warenkoerbe_content(
      (std::istreambuf_iterator<char>(warenkoerbe_file)),
      std::istreambuf_iterator<char>());
  ...
  std::string automated_content(
      (std::istreambuf_iterator<char>(automatic_file)),
      std::istreambuf_iterator<char>());
